...
$_SESSION['sIMPCaminho']           = 'Relatório » Frequência » Para comando » Copa do Mundo 2014';
$_SESSION['sIMPUpag']              = $upag;
$_SESSION['sIMPLotacao']           = $_SESSION['sLotacao'];
$_SESSION['sIMPLotacaoDescricao']  = $wnomelota;
$_SESSION['sIMPTituloFormulario1'] = "Relatório de Servidores que aparecem sem Compensação total/parcial da Copa do Mundo 2014";
$_SESSION['sIMPTituloFormulario2'] = "Servidores que aparecem com c&oacute;digo 62014 sem compensação total/parcial at&eacute; " . substr($periodo, -10) . "<br> »» Período para compensação da Copa do Mundo 2014: De " . $periodo . " ««";
            ...
            <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#808040" width="920px" id="AutoNumber1">
                <tr>
                    <td width="100%"  align='center' class="tahomaSize_2">
                        Período:&nbsp;<input name="periodo" type="text" class='alinhadoAoCentro' id="periodo" value='<?= tratarHTML($_SESSION['sIMPPeriodo']); ?>' size="22" readonly>
                    </td>
                </tr>
                <tr>
...
function seleciona_servidores_todos_os_servidores()
{
    ...
    // seleção dos servidores JUNHO a SETEMBRO / 2014
    // com código 62014, horas devidas ref. Copa do Mundo 2014
    $sqlPonto = "";
    for ($x = 6; $x <= 9; $x++)
    {
        $sqlPonto .= "
