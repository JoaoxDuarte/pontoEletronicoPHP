...
$selectOcorrencias = "";
$oDBase->query("SELECT siapecad, desc_ocorr, cod_ocorr FROM tabocfre WHERE ativo = 'S' AND grupo_ocorrencia = 'COVID19' ORDER BY desc_ocorr ");
while ($campo = $oDBase->fetch_array())
{
...
$oForm->setJS("sisref_relatorio_comando_gerar_txt.js?v.0.0.0.0.0.1");
