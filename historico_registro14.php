...
$ocorrenciasPorPeriodo        = $obj->OcorrenciasPorPeriodo($sitcad);

$codigosCredito = array_merge($codigosCredito, $grupoOcorrenciasViagem);
...
if ($modoreg == '13' || in_array($ocor, $codigosCompensaveis))
{
    $sub_titulo  = "Edi&ccedil;&atilde;o de Registro de Horas Devidas";
    $form_action = "historico_gravaregfreq2.php?modo=2";
    $form_submit = "return testa()";
}
elseif ($modoreg == '14' || in_array($ocor, $codigosCredito))
{
    $sub_titulo  = "Edi&ccedil;&atilde;o de Registro de Horas Excedentes";
    $form_action = "historico_gravaregfreq2.php?modo=3";
    $form_submit = "return testa()";
}
elseif ($modoreg == '15' || in_array($ocor, $ocorrenciasPorPeriodo))
{
    //$sub_titulo = "Registro de Ocorr&ecirc;ncia por Per&iacute;odo";
    //$form_action = "historico_gravaregfreq2.php?modo=4";
...
$oForm->setJS("historico_registro14.js");
...
$oForm->setInputHidden('codigoFrequenciaNormalPadrao', implode(',', $codigoFrequenciaNormalPadrao));
$oForm->setInputHidden('grupoOcorrenciasViagem', implode(',', $grupoOcorrenciasViagem));
