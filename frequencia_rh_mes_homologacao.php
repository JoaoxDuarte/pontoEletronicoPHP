...
// dados voltar
$_SESSION['voltar_nivel_1'] = 'frequencia_rh_mes_homologacao.php';
...
$oForm->setJS( "frequencia_rh_mes_homologacao.js" );
$oForm->setIconeParaImpressao('print');
$oForm->setSubTitulo("Manutenção Frequência - Mês em Homologação");
...
function DadosDoServidor($ano, $mes, $upag)
{
    ...
    SELECT
        ...
        servativ.cod_lot,
        und.descricao,
        IF(IFNULL(hom.homologado,'N') NOT IN ('V','S'),'N','S') AS `status`
    FROM
        servativ
    LEFT JOIN
                ...
                for ($x=0; $x < count($dados); $x++)
                {
                    ...
                    <tr>
                        ...
                        <td class="text-center largura-imp-150px" style="width: 14%;">
                            ...
                            <a href="javascript:window.location.replace('frequencia_rh_mes_homologacao_registros.php?dados=<?= $params; ?>')" style="text-decoration:none;cursor:pointer;">Manutenção</a>
