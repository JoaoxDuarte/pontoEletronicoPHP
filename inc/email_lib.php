...
/*
 * Sistema de Envio de email adaptado para o GERIRPGA
 * por William Veronesi Rocha - www.wvr.com.br
 *
 * veja o exemplo abaixo de uso:
 *
 * include("./email.php");
 * $email = new Email();
 * $email->auth("servidor smtp", "porta", "usuário","senha");
 * $email->attach("caminho do arquivo a ser anexado");
 * $email->send("Teste de Email", "Corpo da Mensagem de Teste", "endereço destino", "nome destino", "endereço origem", "nome origem");
 *
 */
...
/* arquivo com as funcoes principais - class email */
...
class Email
{
    ...
    function auth($host, $port, $username, $password)
    {
        ...
        $GLOBALS['phpmailer']->Host     = $host;
        $GLOBALS['phpmailer']->SMTPAuth = true;
        $GLOBALS['phpmailer']->Username = $username;
        $GLOBALS['phpmailer']->Password = $password;
        $GLOBALS['phpmailer']->Port     = $port;
    ...
    {
        if ($GLOBALS['phpmailer']->AddAttachment($path))
        {
            return true;
        }
        else
