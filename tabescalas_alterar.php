...
<script>
    $(document).ready(function () {
        <?php if ($retorno == "nao_existe"): ?>
            mostraMensagem('Escala não consta do Cadastro de Escalas!', 'danger', "tabescalas.php");
        <?php endif; ?>

        <?php if ($retorno == "gravou"): ?>
            mostraMensagem('Alteração realizada com sucesso!', 'success', "tabescalas.php");
        <?php endif; ?>

        <?php if ($retorno == "nao_gravou"): ?>
            mostraMensagem('Alteração NÃO foi realizada!', 'danger', "tabescalas.php");
        <?php endif; ?>
