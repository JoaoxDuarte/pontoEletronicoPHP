...
$oForm->setJS('cadastro_exclusao_cancela.js'); // script extras utilizados pelo formulario
        ...
        <div style='text-align:right;width:90%;margin:25px;font-size:9px;border:0px;'>
            <fieldset style='border:1px solid white;text-align:left;'>
                ...
                <p style='padding:1px;margin:0px;'>
                    <b>Matrícula SIAPE&nbsp;:&nbsp;</b><b></b>Matrícula do servidor/estagiário a ser recuperada.
                </p>
            </fieldset>
        </div>
    </div>
