...
if(!empty($_POST)){
    ...
    if($bool)
    {
        ...
        setMensagemUsuario('Ciclo cadastrado com sucesso para o período de '.$start_date.' a '.$end_date.'!','success');
    ...
    <script>
        ...
        function validateForm() {
            ...
            if(ConverteParaData(datestart) < ConverteParaData(data_current)){
                mostraMensagem("Data inicial não pode ser menor que a data atual!", 'warning');
                hideProcessandoAguarde();
                return false;
            }

            if(ConverteParaData(dateend) < ConverteParaData(data_current)){
                mostraMensagem("Data final não pode ser menor que a data atual!", 'warning');
                hideProcessandoAguarde();
                return false;
            }
