...
$oForm->setCaminho("Utilitários » Gestores » Reinicializar Senha do Usuário");
...
// Topo do formulário
//
$oForm->setSubTitulo("Reinicializar a Senha do Usuário");
...
else if ($modo == '1')
{
    ...
    {
        mensagem('Servidor/Estagiário não cadastrado!', 'gestao_trocasenha_usuario.php?modo=0', 1);
    }
    else
    {
            ...
            <form method="POST" action="#" onsubmit="return verificadados(2)" id="form1" name="form1">
                <p align="center"><h3>
                    ...
                    <p align="center" style="word-spacing: 0; margin: 0">
                        ...
                        <input type="button" id="voltar" name="voltar" alt="Retorna sem confirmar" align="center" value='&nbsp;Não&nbsp;' onclick="javascript:history.go(-1);window.location.replace('gestao_trocasenha_usuario.php?modo=0');">
                    </p>
            </form>
        </center>
        <?php
...
else
{
    ...
    if ($msg == 0)
    {
        mensagem('Usuário deverá usar a data de nascimento!\nSenha já foi reinicializada!\n.', 'gestao_trocasenha_usuario.php?modo=0', 1);
    }
    else if ($msg == -1)
    {
        mensagem('Senha não foi reinicializada!\nPor favor, repita a operação.', 'gestao_trocasenha_usuario.php?modo=0', 1);
    }
    else
    {
        mensagem('Senha reinicializada com sucesso!!!\nO usuário deverá usar a data de nascimento.', 'gestao_trocasenha_usuario.php?modo=0', 1);
    }
}
