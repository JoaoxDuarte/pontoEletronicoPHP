...
$oForm->setSubTitulo( "Relatório de Servidores Requisitados e Descentralizados no mês de homologação" );
$oForm->setJS( "js/phpjs.js" );
$oForm->setJS( "src/views/relatorios/requisitados_descentralizados.js?v.0.6.2.0.3" );
$oForm->setLargura();
