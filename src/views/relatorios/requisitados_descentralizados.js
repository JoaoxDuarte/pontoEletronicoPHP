...
function startTask()
{
    ...
    {
        source = new EventSource("src/views/relatorios/requisitados_descentralizados_sse.php?dados="+dados+"&filtrar="+filtrar);
        ...
        source.addEventListener("message", function(e)
        {
            ...
            if(e.lastEventId === 'CLOSE')
            {
                ...
                if (registros == 0)
                {
                    addLinhas('N&atilde;o h&aacute; servidores requisitados/descentralizados sem frequ&ecirc;ncia!!');
                }
            }
            else
            {
