    ...
    public function registrosCargoRetornoAjax()
    {
        ...
        while ($dados = $oDBase->fetch_object())
        {
            ...
            $result[] = array(
                ...
                str_to_utf8($dados->DESC_CARGO),
                str_to_utf8($dados->PERMITE_BANCO),
                str_to_utf8($dados->SUBSIDIOS),
                str_to_utf8(($dados->ativo != "S" ? "NÃO" : "SIM")),
            );
        }
