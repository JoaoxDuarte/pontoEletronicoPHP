...
if ($oDBase->num_rows() == 0 || ("$ano-$mes-$diat" < "$anot-$compt-01" && "$ano-$mes-$diat" != "0000-00-00"))
{
    ...
    $oDBase->query("INSERT INTO ilegal (siape, operacao, datag, hora, maquina, setor) VALUES('$sMatricula','Tentativa de abonar o dia $dia da ficha do servidor $mat pertencente a competências anteriores à homologação por alteração de endereço no browser.','$vDatas','$vHoras','$ip', '$sLotacao') ");
