...
include_once( _DIR_INC_ . "calculo_horas_comuns_saldos.php" ); // Localização /inc
...
switch ($relatorioTipo)
{
    ...
    case '1': // Extrato em outro documento
        ...
        $html2       .= "<div align='center'><table border='0' cellspacing='0' cellpadding='0' style='margin: 0px 0px 0px 0px; text-align: center; width: 100%;'><tr><td style='width: 105px; border: 0px solid #808080;'><a id='prepara_impressao' title='Preparar Página para Impressão' href=\"javascript:var tela = window.open('veponto_saldos_imp.php','','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,maximized=yes,width=640, height=665');\"><img src='" . _DIR_IMAGEM_ . "print.gif' height=16 border='0'><br>Imprimir</a></td><td style=' width: 60%; height: 25px; vertical-align: middle;'><p align='center' class='ft_14_001'>SISREF - Sistema de Registro Eletrônico de Frequência</p></td><td width='20%'><img src='" . _DIR_IMAGEM_ . "transp1x1.gif' height='16' width='105px' border='0'></td></tr></table><table align='center' border='0' width='100%' cellspacing='0' cellpadding='0'><tr><td colspan='3' align='center'><font class='ft_16_001'>EXTRATO FREQUÊNCIA</font></td></tr><tr><td colspan='3' align='center'><img src='" . _DIR_IMAGEM_ . "transp1x1.gif' height='6' border='0'></td></tr></table></div>";
        $html2       .= "<div align='left'><table border='0' cellspacing='0' cellpadding='0'><tr><td nowrap style='height: 30px; vertical-align: bottom; font-size: 10px; font-weight: normal; font-type: italic;'>$sSiape&nbsp;-&nbsp;$nome</td></tr></table></div>";
        $html2       .= "<fieldset class='fieldsetw' align='left' style='width: 480px;'>";
        $html2       .= "<table cellpadding='0' cellspacing='0' style='border-collapse: collapse;'>";
        $html2       .= "<tr>";
        $html2       .= "<td class='tdTitulo' width='60'>MÊS/ANO</td>";
        $html2       .= "<td nowrap class='tdTitulo2' width='160'>&nbsp;DÉBITO&nbsp;MÊS ANTERIOR<br><small>(A)</small>&nbsp;</td>";
        $html2       .= "<td nowrap class='tdTitulo2' width='51'>&nbsp;CRÉDITOS&nbsp;<br><small>(B)</small></td>";
        $html2       .= "<td nowrap class='tdTitulo2' width='51'>&nbsp;SUB-TOTAL&nbsp;<br><small>(C)</small></td>";

        $html2 .= "<td nowrap class='tdTitulo2' width='54' style='text-align: center;'>DÉBITO&nbsp;MÊS<br>ANTERIOR&nbsp;QUE<br>APARECE&nbsp;SEM<br>COMPENSAÇÃO<br><small>(D)</small></td>";

        $html2 .= "<td nowrap class='tdTitulo2' width='51'>&nbsp;SUB-TOTAL&nbsp;<br><small>(E)</small></td>";
        $html2 .= "<td nowrap class='tdTitulo2' width='51'>&nbsp;DÉBITOS&nbsp;<br><small>(F)</small></td>";
        $html2 .= "<td nowrap class='tdTitulo2' width='51'>&nbsp;SALDO DEVEDOR&nbsp;<br><small>(G)</small></td>";
        $html2 .= "<td nowrap class='tdTitulo2'>SITUAÇÃO</td>";
        $html2 .= "</tr>";
        ...
        for ($nI = $tam; $nI >= 0; $nI--)
        {
            ...
            if ($comp_invertida >= $comp_inicial && $comp_invertida <= $comp_final)
            {
                ...
                $ftf_red      = "</font>";
                // exibe em cinza escuro se zero
                $zerado_cinza = "<font style='color: #8b8b8b; font-weight: bold;'>00:00</font>";

                // debito do mes anterior
                $sDebitoMesAnterior = $aHorasComuns[$nI + 0][2] . $aHorasComuns[$nI + 0][3];
                $sDebitoMesAnterior = ($aHorasComuns[$nI + 0][2] == '-' ? $fti_red . $sDebitoMesAnterior . $ftf_red : $sDebitoMesAnterior);

                // creditos mes atual
                $sCreditoMesAtual = $aHorasComuns[$nI + 1][2] . $aHorasComuns[$nI + 1][3];
                $sCreditoMesAtual = ($aHorasComuns[$nI + 1][2] == '-' ? $fti_red . $sCreditoMesAtual . $ftf_red : $sCreditoMesAtual);

                // sub-total
                $sSubTotal = $aHorasComuns[$nI + 2][2] . $aHorasComuns[$nI + 2][3];
                $sSubTotal = ($aHorasComuns[$nI + 2][2] == '-' ? $fti_red . $sSubTotal . $ftf_red : $sSubTotal);

                // debitos mes atual
                $sDebitoMesAtual = $aHorasComuns[$nI + 3][2] . $aHorasComuns[$nI + 3][3];
                $sDebitoMesAtual = ($aHorasComuns[$nI + 3][2] == '-' ? $fti_red . $sDebitoMesAtual . $ftf_red : $sDebitoMesAtual);

                // saldo
                $sSaldo = $aHorasComuns[$nI + 4][2] . $aHorasComuns[$nI + 4][3];
                $sSaldo = ($aHorasComuns[$nI + 4][2] == '-' ? $fti_red . $sSaldo . $ftf_red : ($sSaldo == '00:00' ? '----------' : $sSaldo));

                $contar++;
                if ($contar == 5)
                {
                    $corLinha = ($corLinha == '#f2f2f2' ? '#FFFFFF' : '#f2f2f2');
                    $html2    .= "<tr style='background-color: $corLinha;'>";
                    $html2    .= "<td class='tdLinha'  width='60' nowrap>&nbsp;&nbsp;" . tratarHTML(substr($aHorasComuns[$nI][0], 0, 2)) . ' / ' . tratarHTML(substr($aHorasComuns[$nI][0], 2, 4)) . "</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . tratarHTML($sDebitoMesAnterior) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . tratarHTML($sCreditoMesAtual) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . tratarHTML($sSubTotal) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . ($aHorasComuns[$nI + 2][3] != '00:00' && $aHorasComuns[$nI + 2][2] == '-' ? '<b>' . str_replace('red', '#ae5700', str_replace('-', '+', tratarHTML($sSubTotal))) . '</b>' : $zerado_cinza) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . ($aHorasComuns[$nI + 2][3] != '00:00' && $aHorasComuns[$nI + 2][2] == '-' ? '00:00' : tratarHTML($sSubTotal)) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . tratarHTML($sDebitoMesAtual) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha2' width='51' nowrap>&nbsp;" . tratarHTML($sSaldo) . "&nbsp;</td>";
                    $html2    .= "<td class='tdLinha' nowrap>&nbsp;" . ($comp_invertida == date('Ym') ? "<i>EM ANDAMENTO</i>" : tratarHTML($aHorasComuns[$nI + 4][4])) . "&nbsp;</td>";
                    $html2    .= "</tr>";
                    $contar   = 0;
                }
            }
        ...
        $html2  .= "</table>";
        $html2  .= "<table cellpadding='0' cellspacing='0' style='border-collapse: collapse;'>";
        $html2  .= "<tr><td class='lnTitulo' height='22' valign='top'>&nbsp;<b>Observação:</b>&nbsp;O saldo do mês " . date('m/Y') . " é parcial e está sujeito a alterações.</td></tr>";
        $html2  .= "</table>";
        $nWidth = '580px';
        $html2  .= legendaSaldoCompensacaoDoMes(1, $nWidth);
        $html2  .= legendaSaldoCompensacaoDoMes(2, $nWidth);
        $html2  .= legendaSaldoCompensacaoDoMes(3, $nWidth);
        $html2  .= "</fieldset>";
        print $html2;
    ...
    default: // Extrato
        if ($bSoSaldo == false)
        {
            $html = "<html><head><title></title><meta http-equiv='Content-Language' content='pt-br'><meta http-equiv='Content-Type' content='text/html; charset=windows-1252'><link rel='stylesheet' type='text/css' href='" . _DIR_CSS_ . "estilos.css'></style><link rel='stylesheet' type='text/css' href='" . _DIR_CSS_ . "print3.css'></style><script language=JavaScript src='" . _DIR_JS_ . "funcoes.js'></script><style>.titulo { font-size: 11px; font-family: arial; font-weight: bold; height: 20px; background-color: #DFDFBF; text-align: center; vertical-align: middle; }.textos10 { font-size: 12px; font-family: arial; font-weight: normal; background-color: transparent; text-align: justify; vertical-align: middle; }.textos11 { font-size: 12px; font-family: arial; font-weight: normal; background-color: transparent; text-align: center; vertical-align: middle; }.textos20 { font-size: 13px; font-family: arial; font-weight: normal; background-color: transparent; text-align: justify; vertical-align: middle; }.textos10b { font-size: 12px; font-family: arial; font-weight: normal; background-color: #f3f3f3; text-align: justify; vertical-align: middle; }.textos11b { font-size: 12px; font-family: arial; font-weight: normal; background-color: #f3f3f3; text-align: center; vertical-align: middle; }.textos20b { font-size: 13px; font-family: arial; font-weight: normal; background-color: #f3f3f3; text-align: justify; vertical-align: middle; }</style></head><body bgcolor='#FFFFFF' ><script language=JavaScript src='" . _DIR_JS_ . "menu/frames_body_array.js' type=text/javascript></script><script language=JavaScript src='" . _DIR_JS_ . "menu/mmenu.js' type=text/javascript></script><fieldset align='center' style='width: 800; height: 100%;'><table align='center'" . ($quebra == 'sim' ? " style='page-break-before: always'" : "") . "><tr><td><p align='center' style='word-spacing: 0; line-height: 100%; margin-left: 0; margin-right: 0; margin-top: 6; margin-bottom: 0'><b><h3>
				...
				<div align='center'>
				<font size='1'>
				Horário Especial: <b>" . ($hora_especial == 'S' ? "SIM, ".$processo_hespecial : 'NÃO') . "</b>
				</font>
				</div>
				</td>
				</tr>";
        ...
        for ($xx = $nRows; $xx > 0; $xx -= 5)
        {
            ...
            for ($y = 4; $y >= 0; $y--)
            {
                ...
                $html       .= "<tr><td class='textos10" . $class . "' $style><div style='margin: 7px;'>" . $sDescricao . "</div></td><td class='textos11" . $class . "' $style><table border='0'><tr><td class='textos11" . $class . "' style='width: 10px; vertical-align: middle;'>" . $aHorasComuns[$nI][2] . "</td><td class='textos11" . $class . "' style='vertical-align: middle;'>" . $sHoras . "</td></tr></table></td>";
                if ($y == 4)
                {
...
function imprimirSaldoCompensacaoDoMes($extrato = false, $dados=NULL)
{
    ...
    $corTituloBG = "#b5b56a"; //#808040 //#DFDFBF < #ddddff
    $html2       .= "<table class='tablew21' width='790px' border='0' align='center' cellpadding='0' cellspacing='0' id='AutoNumber1' style='bordercolor: #808040; border-collapse: collapse'>";
    $html2       .= "<tr><td colspan='7' style='border: 0px; height: 3px;'></td></tr>";

    $html2 .= "<tr>";
    $html2 .= "<td nowrap width='35%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;' height='22'>&nbsp;</td>";
    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;' nowrap>&nbsp;Débito Mês Anterior<br><small>(A)</small>&nbsp;</td>";
    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Créditos&nbsp;<br><small>(B)</small></td>";
    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Sub-Total&nbsp;<br><small>(C)</small></td>";

    $html2 .= "<td nowrap width='12%' class='ftFormFreq-bc-1' style='text-align: center; border: 1px solid #808040;'>Débito&nbsp;Mês<br>Anterior&nbsp;que<br>Aparece&nbsp;sem<br>Compensação<br><small>(D)</small></td>";

    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Sub-Total&nbsp;<br><small>(E)</small></td>";
    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Débitos&nbsp;<br><small>(F)</small></td>";
    $html2 .= "<td nowrap width='10%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Saldo&nbsp;<br><small>(G)</small></td>";
    $html2 .= "<td nowrap width='15%' class='ftFormFreq-bc-1' style='border: 1px solid #808040;'>&nbsp;Ocorrência&nbsp;</td>";
    $html2 .= "</tr>";
    ...
    for ($nI = $tam; $nI >= 0; $nI--)
    {
        ...
        if ($sCompetencia == $comp || $extrato == true)
        {
            ...
            if ($contar == 5 || $extrato == true)
            {
                ...
                $html2         .= "<tr style='background-color: $corLinha;'>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;&nbsp;<b>Horas Comuns - &nbsp;" . tratarHTML(substr($aHorasComuns[$nI][0], 0, 2)) . ' / ' . tratarHTML(substr($aHorasComuns[$nI][0], 2, 4)) . "</b>&nbsp;&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . tratarHTML($sMesAnterior) . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . tratarHTML($sCreditos) . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . tratarHTML($sSubTotal) . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . (time_to_sec($aHorasComuns[$nI + 2][3]) != 0 && $aHorasComuns[$nI + 2][2] == '-' ? '<b>' . str_replace('red', '#ae5700', str_replace('-', '+', tratarHTML($sSubTotal))) . '</b>' : '00:00') . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . (time_to_sec($aHorasComuns[$nI + 2][3]) != 0 && $aHorasComuns[$nI + 2][2] == '-' ? '00:00' : tratarHTML($sSubTotal)) . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . tratarHTML($sDebitos) . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;" . ($sCompetencia == date('Ym') || $sCompetencia == $comp ? tratarHTML($sSaldo) : '----------') . "&nbsp;</div></td>";
                $html2         .= "<td class='tdLinha' nowrap><div>&nbsp;<b>" . (time_to_sec($aHorasComuns[$nI + 4][3]) != 0 && $aHorasComuns[$nI + 4][2] == '-' ? tratarHTML(implode(',', $codigoDebitoPadrao)) : (time_to_sec($aHorasComuns[$nI + 4][3]) == 0 ? '----------' : tratarHTML(implode(',', $codigoCreditoPadrao)))) . "</b>&nbsp;</div></td>";
                $html2         .= "</tr>";
    ...
    $html2 .= "</table>";
    $html2 .= "<table width='790px' border='0' align='center' cellpadding='0' cellspacing='0' style='bordercolor: #808040; border-collapse: collapse;'>";
    $html2 .= "<tr>";
    if ($saldo_parcial == true)
    {
        $html2 .= "<td class='lnTitulo' height='22' valign='top' width='500px'>&nbsp;<b>Observação:</b>&nbsp;O saldo do mês " . date('m/Y') . " é parcial e está sujeito a alterações.</td>";
    }
    else
    {
        $html2 .= "<td class='lnTitulo' height='22' align='center' valign='top' width='500px'>&nbsp;</td>";
    }
    $html2 .= "<td class='lnTitulo' height='22' align='center' valign='top' width='290px'>&nbsp;<a id='show-saldos' style='cursor: pointer;'><u>Clique aqui para visualizar todos os meses</u></a><input type='hidden' id='veponto_saldos' value='" . base64_encode(($sSiape == '' ? tratarHTML($pSiape) : tratarHTML($sSiape)) . ":|:1") . "'></td>";
    $html2 .= "</tr>";
    $html2 .= "</table>";
    $html2 .= legendaSaldoCompensacaoDoMes(1);
...
{
    global $relatorioTipo, $codigoCreditoPadrao, $codigosAgrupadosParaDesconto;
    ...
    switch ($tipo)
    {
        ...
        case 3:
            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2' nowrap>(A)&nbsp;DÉBITO MÊS ANTERIOR:&nbsp;</td><td class='tdLinha4'>Contém o resultado da diferença apurada no mês anterior, <small><b>SALDO DEVEDOR</b></small>. Ocorrências " . tratarHTML(implode(', ', $codigosAgrupadosParaDesconto)) . ";</td></tr></table></td></tr>";
            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2' nowrap>(B)&nbsp;CRÉDITOS:&nbsp;</td><td class='tdLinha4'>Horas de crédito acumulados dentro do mês de competência (" . tratarHTML(implode(",", $codigoCreditoPadrao)) . ");</td></tr></table></td></tr>";
            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2' nowrap>(C)&nbsp;SUB-TOTAL:&nbsp;</td><td class='tdLinha4'>(A-B):&nbsp;Diferença entre as horas de <small><b>CRÉDITOS (B)</b></small> acumulados dentro do mês de competência e as de <small><b>DÉBITO do MÊS ANTERIOR (A)</b></small>;</td></tr></table></td></tr>";

            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2'>(D)&nbsp;DÉBITO&nbsp;MÊS&nbsp;ANTERIOR&nbsp;QUE&nbsp;APARECE&nbsp;SEM&nbsp;COMPENSAÇÃO:&nbsp;</td><td class='tdLinha4'>Débito do mês anterior que aparece como não compensado. Resultado da coluna \"C\".</td></tr></table></td></tr>";

            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2'>(E)&nbsp;SUB-TOTAL:&nbsp;</td><td class='tdLinha4'>(C-D):&nbsp;Resultado da diferença entre a coluna \"C\" e \"D\";</td></tr></table></td></tr>";
            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2'>(F)&nbsp;DÉBITOS:&nbsp;</td><td class='tdLinha4'>Horas de atrasos, saídas antecipadas e faltas justificadas acumuladas dentro do mês de competência;</td></tr></table></td></tr>";

            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2' nowrap>(G) " . ($relatorioTipo == '1' ? "SALDO DEVEDOR" : "SALDO") . ":&nbsp;</td><td class='tdLinha4'>(E-F):&nbsp;Resultado final do mês de competência, sendo negativo é tansportado para o mês seguinte.<br>Quando consta '----------', na coluna \"Ocorrência\", significa que não há débito no mês de competência.<br></td></tr></table></td></tr>";

            $legenda .= "<tr><td><table cellpadding='0' cellspacing='0'><tr><td class='lnTitulo2' nowrap>Obs:&nbsp;</td><td class='tdLinha4'>1) O código na coluna \"Ocorrência\", quando exibido, refere-se à coluna \"Saldo\".<br>2) As horas credoras no mês, decorrente de compensação autorizada pela chefia, são utilizadas exclusivamente para compensa&ccedil;&atilde;o de atrasos, faltas justificadas, sa&iacute;das antecipadas e aus&ecirc;ncias dentro do mês de competência e do imediatamente anterior.</td></tr></table></td></tr>";
            $legenda .= "</table>";
            $legenda .= "</fieldset>";
            break;
    }
