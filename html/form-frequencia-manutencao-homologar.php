        ...
        <div class="form-group">
            <div class="col-md-3 col-md-offset-1">
                <a class="btn btn-success btn-block" id="btn-continuar" role="button">
                    <span class="glyphicon glyphicon-ok"></span> Concluir Homologação
                </a>
            </div>
            ...
            <div class="col-md-3 col-xs-6">
                <a class="btn btn-danger btn-block" href='javascript:window.location.replace("frequencia_homologar.php?dados=<?= $destino_voltar; ?>");' role="button">
