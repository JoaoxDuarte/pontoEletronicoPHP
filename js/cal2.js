...
var titleColor = "#20B7FF";
var daysColor = "#F3F3F3";
var bodyColor = "#CAEEFF";
var dayColor = "#ffffff";
var currentDayColor = "#FF9999";
var footColor = "#B9E9FF";
var borderColor = "#0080C0";

var titleFontColor = "#FFFFFF";
var daysFontColor = "#6699FF";
var dayFontColor = "#333333";
var currentDayFontColor = "#ffffff";
var footFontColor = "#3399CC";
...
// codes
var calWidth = 180, calHeight = 200, calOffsetX = -200, calOffsetY = 16;
var calWin = null;
var winX = 0, winY = 0;
var cal = "cal";
var cals = new Array();
...
var yxMonths = new Array("Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro");
var yxDays = new Array("Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado", "Domingo");
...
function showCal(name)
{
    ...
    if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field])
    {
        ...
        if (!hasCal)
        {
            if (isIE || isOpera6)
            {
                calWin = window.open("", "cal", "toolbar=0,width=" + calWidth + ",height=" + calHeight + ",left=" + (winX + calOffsetX) + ",top=" + (winY + calOffsetY) + "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0");
            }
            else
            {
                calWin = window.open("", "cal", "toolbar=0,width=" + calWidth + ",height=" + calHeight + ",screenx=" + (winX + calOffsetX) + ",screeny=" + (winY + calOffsetY) + "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=0,resizable=0");
            }
        }
